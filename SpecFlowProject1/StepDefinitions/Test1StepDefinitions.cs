...
namespace SpecFlowProject1.StepDefinitions
{
    ...
    public class Test1StepDefinitions
    {
        ...
        { 
            ...
            phonenumber = "735456388";//User phone
        ...
        {
            if (_calculatorPageObject.CurrentURL() != $"{startPage}/account/register")
            { _calculatorPageObject.GotoPage9(); }
        ...
        public void ThenTheUserIsTakeToSkapaLosenordPage()
        {
            ...
            string actualResult = _calculatorPageObject.CurrentURL();
            string desired_page = $"{startPage}/book/register-qr?QrCode=" + bookQRcode;
            actualResult.Should().Be(desired_page);
            //string actualResult = _calculatorPageObject.CurrentURL();
            //string desired_page = $"{startPage}/account/create-password";
            //actualResult.Should().Be(desired_page);
        }
