...
namespace CalculatorSelenium.Specs.PageObjects
{
    ...
    public class CalculatorPageObject
    {
        ...
        private const string CalculatorUrl = "https://www.reink.se/";
        ...
        private IWebElement FirstNumberElement => _webDriver.FindElement(By.ClassName("logg"));
        private IWebElement SecondNumberElement => _webDriver.FindElement(By.ClassName("btn btn-lg btn-primary"));
